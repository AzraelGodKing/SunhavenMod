...
**Version 1.4.4** — In-game task tracker for farming goals, quests, and daily tasks. Categories, priorities, per-character saves, parchment-style UI. Default hotkey: **Ctrl+T**.
