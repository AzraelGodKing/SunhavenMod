...
namespace HavenDevTools.UI
{
    ...
    public class DebugWindow : MonoBehaviour
    {
        ...
        {
            ("com.azraelgodking.havendevtools", "Haven Dev Tools", "1.2.0"),
            ("com.azraelgodking.senpaischest", "Senpai's Chest", "2.6.0"),
            ("com.azraelgodking.squirrelsbirthdayreminder", "Birthday Reminder", "1.4.0"),
            ("com.azraelgodking.havensbirthright", "Haven's Birthright", "2.2.0"),
            ("com.azraelgodking.sunhavenmuseumutilitytracker", "S.M.U.T.", "2.4.0"),
            ("com.azraelgodking.sunhaventodo", "Sunhaven Todo", "1.4.0"),
            ("com.azraelgodking.thevault", "The Vault", "3.3.0"),
            ("com.azraelgodking.havensalmanac", "Haven's Almanac", "1.4.0"),
            ("com.azraelgodking.fasterraces", "Faster Races", "1.4.0"),
            ("com.azraelgodking.trinketfortune", "Trinket Fortune", "1.2.0"),
            ("com.azraelgodking.cropoptimizer", "Crop Optimizer", "1.4.0"),
            ("com.azraelgodking.havensrespec", "Haven's Respec", "1.3.0"),
        };
