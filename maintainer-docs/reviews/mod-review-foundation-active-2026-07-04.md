...
|---|------|----------|--------|-------|
| 1.1 | **CharacterSaveStore** in SharedUtilities | Highest | Done | Todo, Gifting Assistant, SMUT, Senpai's Chest, Birthday Reminder favorites, The Vault (sanitize + atomic bytes); SMUT PlayerPatches |
