...
- **Release & Publish:** Grant `contents: write` on each reusable release caller job — nested `release-mod` was rejected at startup ([run #138](https://github.com/AzraelGodKing/SunhavenMod/actions/runs/27860332770)).
