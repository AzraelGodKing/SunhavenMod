...
- **Nexus upload:** Release workflow pins **`Nexus-Mods/upload-action@v1.0.0-beta.3`** — the Nexus Mods API returns multipart/upload responses inside a **`data`** envelope; **beta.2** expected a flat body and crashed with *Cannot read properties of undefined (reading 'length')*.
